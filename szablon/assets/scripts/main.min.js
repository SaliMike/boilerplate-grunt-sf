...
var Loader = {
  ...
  init: function init(args) {
    this.settings = _jquery2.default.extend(true, this.settings, args);
  ...
  catchDOM: function catchDOM(settings, callback) {
    var target = (0, _jquery2.default)(settings.target);
    this.$target = {
      root: target
    };
  ...
  deleteLoader: function deleteLoader() {
...
},{"./loader/loader":1,"jquery":3}],3:[function(require,module,exports){
/*!
